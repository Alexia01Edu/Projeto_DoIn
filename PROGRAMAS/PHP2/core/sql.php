...
function insert (string $entidade, array $dados) : string
{
    ...
    //nos repositorios tem os array $dados, e os valores que eles recebem
    ...
    //função implode() tranforma em string esses valores.
    ...
    $instrucao .= "({$campos})";
    //o array $campos contem todas os campos da tabela do banco de dados que serão preenchidos, armazenados em uma string;
    ...
    //VALUES é utilizado quando vamos informar os valores a se inserir dados no banco de dados, 
    //nesse caso os valores estão na string armazenada na variavel: $valores;
    //EX: VALUES ('".$dataNasc."', '".$nome."','".$email."','".$senha."','".$cpf."','".$telefone."')";
